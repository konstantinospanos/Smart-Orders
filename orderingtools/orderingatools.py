...
class MainLayout(BoxLayout):
    ...
    def orders(self,*args):
        ...
        app.url_request(app.server_url + 'view_order/'+app.apikey,params, self.orders_success, app.error_request, app.failure_request)
    ...
    def currentaccount(self,*args):
        ...
        payload = {'customerid': app.customerid}
        params = urllib.urlencode(payload)
        app.url_request(app.server_url + 'account/'+app.apikey, params, self.currentaccount_success,app.error_request, app.failure_request)
    ...
    def change_password(self):
        ...
        if app.apikey:
            ...
            params = urllib.urlencode(payload)
            app.url_request(app.server_url + 'users/changepass/'+app.apikey,  params, 
    ...
    def create_user(self, *args):
        ...
        params = urllib.urlencode(payload)
        if app.apikey:
            app.url_request(app.server_url + 'users/createuser/'+app.apikey, params, 
    ...
    def delete_user(self, btn, *args):
        ...
        params = urllib.urlencode(payload)
        if app.apikey:
            app.url_request(app.server_url + 'users/deleteuser/'+app.apikey, params, 
                            self.delete_user_success, app.error_request,  app.failure_request)
    ...
    def change_password(self):
        ...
        if app.apikey:
            ...
            params = urllib.urlencode(payload)
            app.url_request(app.server_url + 'users/changepass/'+app.apikey,  params, 
                            self.change_password_success, app.error_request, app.failure_request)
    ...
    def edit_user(self, firstname, lastname, username, email, role):
        ...
        if app.apikey:
            ...
            params = urllib.urlencode(payload)
            app.url_request(app.server_url + 'users/edituser/'+app.apikey,  params, 
                            self.edit_user_success, app.error_request, app.failure_request)
...
class OrderingApp(App):
    ...
    def do_login(self, username, password):
        ...
        self.url_request(self.server_url + 'login/'+self.apikeydefault, params, 
