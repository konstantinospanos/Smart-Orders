...
class OrderScreen(Screen):
    ...
    def btn_back_managementorders(self,btn,*args):# button < back management order 
        ...
        app.root.url_request(app.root.server_url.replace("\n","") + 'data/backmanagement/'+app.root.apikey, params, self.btn_back_managementorders_success, app.root.error_request, app.root.failure_request)
    ...
    def delete_order(self,*args): # delete order with orderid
        ...
        params = urllib.urlencode(payload)
        app.root.url_request(app.root.server_url.replace("\n","") + 'data/deleteorder/'+app.root.apikey, params, self.delete_order_success, app.root.error_request, app.root.failure_request)
    ...
    def send_data(self,neworder=True,*args): #send order,table,total
        ...
        if app.root.apikey:
            if neworder:
                ...
                params = urllib.urlencode(payload)
                app.root.url_request(app.root.server_url.replace("\n","") + 'data/insertorder/'+app.root.apikey, params, self.send_data_success,app.root.error_request,app.root.failure_request)
            else:
                ...
                app.root.url_request(app.root.server_url.replace("\n","") + 'data/updateorder/'+app.root.apikey, params, self.send_data_success,app.root.error_request,app.root.failure_request)
