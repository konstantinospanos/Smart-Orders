...
class Ordermanagement(Screen):
    ...
    def total_order(self,*args):
        ...
        app.root.url_request(app.root.server_url + 'total/'+app.root.apikeydefault, params, self.total_order_success, app.root.error_request, app.root.failure_request)
    ...
    def pay_order(self,orderid,btn,*args):
        ...
        params = urllib.urlencode(payload)
        app.root.url_request(app.root.server_url + 'pay/'+app.root.apikeydefault, params, self.pay_order_success, app.root.error_request, app.root.failure_request)
    ...
    def pay_all(self,orderid,*args):
        ...
        payload = {'table':app.root.order_scr.thesi_lbl.text.split(' ')[1]}
        params = urllib.urlencode(payload)
        app.root.url_request(app.root.server_url + 'payall/'+app.root.apikey, params, self.pay_all_success, app.root.error_request, app.root.failure_request)
